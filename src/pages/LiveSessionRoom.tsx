...
export default function LiveSessionRoom() {
  ...
  if (status === 'loading' || status === 'joining') {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-[#080b16] text-white/70">
  ...
  if (status === 'error') {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-[#080b16] px-6 text-center">
