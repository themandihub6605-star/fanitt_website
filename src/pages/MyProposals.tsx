          ...
          {TABS.map((t) => (
            <button
              ...
              className={cn(
                ...
                tab === t.key ? 'border-orange-400/60 bg-orange-500/15 text-orange-300' : 'border-white/10 bg-white/[0.04] text-white/60 hover:border-white/20'
              )}
            >
              {t.label}
            ...
            {proposals.map((p, i) => (
              ...
              >
                <Link
                  ...
                  className="block rounded-2xl border border-white/10 bg-white/[0.05] p-5 transition-colors hover:border-white/20"
                >
