    ...
    <div className="pt-28 pb-24">
      <Container className="max-w-2xl">
        ...
        <motion.div
          ...
          className="mt-6 rounded-[2rem] border border-white/10 bg-white/[0.06] p-8 backdrop-blur-xl"
        >
              ...
              <motion.form key="form" exit={{ opacity: 0 }} className="mt-7 space-y-4" onSubmit={handleSubmit}>
                <label className="block">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-white/10 bg-white/[0.04] px-4 py-3 text-white placeholder:text-white/30 focus:border-orange-400 focus:ring-2 focus:ring-orange-400/20"
                  />
                </label>
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <label className="block">
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-white/10 bg-white/[0.04] px-4 py-3 text-white focus:border-orange-400 focus:ring-2 focus:ring-orange-400/20"
                    >
                      {categories.map((c) => (
                ...
                <label className="block">
                  ...
                  <textarea
                    ...
                    className="w-full resize-none rounded-xl border border-white/10 bg-white/[0.04] px-4 py-3 text-white placeholder:text-white/30 focus:border-orange-400 focus:ring-2 focus:ring-orange-400/20"
                  />
                </label>
