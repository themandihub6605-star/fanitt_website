        ...
        <AnimatePresence>
          {creating && (
            <motion.form
              ...
              className="mt-6 flex flex-wrap items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.05] p-5"
            >
              <input
                required
                value={newName}
                ...
                className="min-w-[240px] flex-1 rounded-lg border border-white/10 bg-white/[0.04] px-3 py-2 text-sm text-white placeholder:text-white/30 focus:border-orange-400"
              />
