        ...
        <div className="mt-8 flex flex-wrap gap-2">
          <button
            ...
            className={cn(
              ...
              filter === 'All' ? 'border-orange-400/60 bg-orange-500/15 text-orange-300' : 'border-white/10 bg-white/[0.04] text-white/60 hover:border-white/20'
            )}
          >
            All
          </button>
          {categories.map((c) => (
            <button
              ...
              className={cn(
                'rounded-full border px-3.5 py-1.5 text-xs font-semibold transition-colors',
                filter === c._id ? 'border-orange-400/60 bg-orange-500/15 text-orange-300' : 'border-white/10 bg-white/[0.04] text-white/60 hover:border-white/20'
              )}
            >
              {c.label}
            </button>
            ...
            {campaigns.map((campaign, i) => (
              ...
              >
                <Link
                  ...
                  className="block h-full rounded-2xl border border-white/10 bg-white/[0.05] p-6 backdrop-blur-xl transition-all hover:-translate-y-1 hover:border-white/20 hover:shadow-lifted"
                >
