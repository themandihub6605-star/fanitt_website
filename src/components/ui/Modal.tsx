        ...
        >
          ...
          >
            <button
              ...
              className="absolute right-4 top-4 rounded-full p-1.5 text-white/60 transition-all duration-200 ease-out hover:rotate-90 hover:bg-white/10 hover:text-white sm:right-5 sm:top-5"
            >
              <X size={18} />
            </button>
