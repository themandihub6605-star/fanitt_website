  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        <Bell size={18} />
        {unreadCount > 0 && (
          <span className="absolute right-1.5 top-1.5 h-2 w-2 rounded-full bg-orange-500 ring-2 ring-[#0d1120]" />
        )}
      </button>
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 mt-3 w-80 overflow-hidden rounded-2xl border border-white/10 bg-[#0d1120] shadow-lifted"
          >
            ...
            <div className="max-h-80 divide-y divide-white/5 overflow-y-auto">
              ...
              {notifications.map((n) => {
                ...
                return (
                  <div key={n._id} className={cn('flex gap-3 px-4 py-3 hover:bg-white/[0.03]', !n.isRead && 'bg-white/[0.02]')}>
