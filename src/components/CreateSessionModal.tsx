          ...
          <motion.form key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onSubmit={handleSubmit} className="space-y-4">
            ...
            <label className="block">
              ...
              {!bannerUrl ? (
                <button
                  ...
                  className="flex h-32 w-full flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-white/15 bg-navy-800/45 text-white/50 transition-colors hover:border-orange-400/40 hover:text-white/70"
                >
                  {bannerUploading ? (
            ...
            <label className="block">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/10 bg-navy-800/55 px-4 py-2.5 text-sm text-white placeholder:text-white/30 focus:border-orange-400 focus:ring-2 focus:ring-orange-400/20"
              />
            </label>
            ...
            <div className="grid grid-cols-2 gap-3">
              <label className="block">
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-white/10 bg-navy-800/55 px-3 py-2.5 text-sm text-white focus:border-orange-400"
                >
                  {categories.map((c) => (
            ...
            <div className="grid grid-cols-2 gap-3">
              <label className="block">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/10 bg-navy-800/55 px-3 py-2.5 text-sm text-white focus:border-orange-400 [color-scheme:dark]"
                />
              </label>
              <label className="block">
