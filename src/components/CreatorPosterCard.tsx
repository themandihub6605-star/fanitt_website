...
export function CreatorPosterCard({ creator, rank }: CreatorPosterCardProps) {
  return (
    <Link
      ...
      className="group relative block aspect-[3/4] w-full overflow-hidden rounded-2xl border border-white/[0.06] shadow-card transition-all duration-300 ease-out hover:-translate-y-1.5 hover:border-orange-500/30 hover:shadow-lifted"
    >
      <img
      ...
      <span className="pointer-events-none absolute inset-x-0 top-0 h-[2px] origin-left scale-x-0 bg-gradient-to-r from-orange-500 via-pink-500 to-yellow-400 transition-transform duration-300 ease-out group-hover:scale-x-100" />
