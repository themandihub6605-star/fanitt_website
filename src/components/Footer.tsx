      ...
      <Container className="relative">
            ...
            <div className="mt-5 flex items-center gap-3">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 transition-all duration-300 ease-out hover:-translate-y-1 hover:scale-110 hover:bg-orange-500 hover:shadow-glow"
                >
                  <social.icon size={16} />
                </a>
              ))}
        ...
        <div className="mt-10 flex flex-col items-start gap-3 border-t border-white/10 pt-8 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-3">
            <a href="#" className="flex items-center gap-2 rounded-xl bg-white/10 px-4 py-2.5 text-sm font-semibold transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-white/20 hover:shadow-card">
