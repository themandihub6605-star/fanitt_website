    ...
    <section className="py-section-mobile md:py-section">
      <Container>
          ...
          {STEPS.map((s, i) => (
            <button
              ...
              className={cn(
                ...
                active === i ? 'border-orange-400/50 bg-orange-500/15' : 'border-white/10 bg-white/[0.06] hover:border-white/15'
              )}
            >
        ...
        <div className="relative mt-6">
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/[0.04] backdrop-blur-xl shadow-lifted">
            <div className="flex items-center gap-2 border-b border-white/10 bg-white/[0.04] px-6 py-3.5">
            ...
            <div className="grid md:grid-cols-2">
              <div className="relative flex min-h-[300px] items-center p-6 sm:min-h-[440px] sm:p-12 md:p-16">
                <div
                  ...
                  style={{ backgroundImage: 'radial-gradient(circle, #232742 1px, transparent 1px)', backgroundSize: '22px 22px' }}
                />
