        ...
        >
          {reviews.map((r, i) => (
            <motion.div
              ...
              className="w-[300px] shrink-0 rounded-2xl bg-white/[0.06] backdrop-blur-xl border border-white/10 p-6 shadow-card transition-shadow duration-300 hover:shadow-lifted"
            >
