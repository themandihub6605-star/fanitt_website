    ...
    <section id="live-sessions" ref={parallaxRef} className="py-section-mobile md:py-section">
      <Container>
        <motion.div
          ...
          className="relative overflow-hidden rounded-[2rem] bg-navy-800/70 backdrop-blur-xl border border-white/10 p-5 shadow-lifted sm:rounded-[2.5rem] sm:p-12 md:p-16"
        >
          <motion.div
            style={{ y }}
          ...
          <div className="relative grid items-center gap-8 lg:grid-cols-2 lg:gap-14">
            ...
            <div className="relative">
              <motion.div
                ...
                className="relative rounded-[1.5rem] border border-white/10 bg-navy-800/45 p-3.5 shadow-card sm:rounded-[1.75rem] sm:p-5"
              >
                <div className="flex items-center gap-2.5 rounded-2xl bg-navy-800/70 p-3 shadow-soft sm:gap-3 sm:p-4">
